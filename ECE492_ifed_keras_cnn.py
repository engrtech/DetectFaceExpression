#ECE492_ifed_keras_cnn.py
#Author : Vyasan Valavil
#Date : 05/26/2024
#This script detects a face and predicts its emotion
#It uses a model and weights developed with a CNN and deep learning methods.
...
#MWe will stick to CNN for detecting faces since it is more accurate and we are not working with video
all_face_locations = face_recognition.face_locations(img,number_of_times_to_upsample=1,model='cnn')
